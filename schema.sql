...
INSERT INTO UserGroupPermissions (UserGroupId, CanView, CanCreateTopics, CanReply, CanEditOwnPosts, CanDeleteOwnPosts, CanFlagPosts, CanLikePosts, CreatedAt) VALUES (2, 1, 1, 1, 1, 1, 1, 1, strftime('%s', 'now'));
